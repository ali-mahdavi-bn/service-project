    ...
    return (
        <PageLayout>
            <section className="container md:pt-10 pt-20">
                ...
                <Seperator />
                <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
                    These are some the basics you need to know about changing the styling with tailwind css, go to the official docs for more info and if you have any issues or queries please feel free to write us at <u>webexpe13@gmail.com</u> or drop a comment on our github discussions <Link href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss/discussions" target="_blank" rel="noopener noreferrer"><u>github.com/nmayur/nextjs-simple-blog-template/discussions</u></Link>.
                </div>
            </section>
        </PageLayout>
    )
