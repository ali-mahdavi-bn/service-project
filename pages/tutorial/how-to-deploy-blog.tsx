            ...
            <div className='container px-3 pb-5 md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    <li>
                        ...
                        If you have a gmail account, goto firebase <Link href="https://firebase.google.com/" target="_blank" rel="noopener noreferrer">https://firebase.google.com/</Link> and goto firebase console.
                    </li>
                    <li>
