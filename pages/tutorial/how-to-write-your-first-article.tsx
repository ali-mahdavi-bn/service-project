                ...
                <List type={ListType.disc} className="mt-5">
                    <li>
                        <Text p className="mt-2">
                            <b>path</b><br />
                            As show in the above image, path contains the file path of our article.<br /> If you have <Link href="https://marketplace.visualstudio.com/items?itemName=christian-kohler.path-intellisense" target="_blank" rel="noopener noreferrer">Path Intellisense</Link> installed in your VS Code, it will be ease to add path, just hit <b>"/"</b> and then auto suggestions will come up, just follow the auto suggestions and set the path of the article file.
                        </Text>
                    </li>
                    <li>
                        <Text p className="mt-2">
