            ...
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    <li className="">
                        ...
                        You can install node via <Link href="https://nodejs.org/en/download/" target="_blank" rel="noopener noreferrer">https://nodejs.org/en/download/</Link> or you can look up any tutorial to install node js on your computer.
                    </li>
                    <li className="">
                        Next You will need a code editor like <b>VsCode / Sublime text</b> to write your blog articles. <br />
                        I will suggest using <b> <Link href="https://code.visualstudio.com/download" target="_blank" rel="noopener noreferrer"> VS Code</Link></b>.
                    </li>

                    <li className="">
                        Download / clone the blog template from our github page to a folder on your computer.
                        <Link href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss" className="pl-2 font-semibold" target="_blank" rel="noopener noreferrer">
                        ...
                        <Image className="mt-3" src="/imp_assets/tutorials/download-code.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li className="">
                    ...
                    <li className="mb-20">
                        ...
                        <br />
                        If you are facing any difficulty, write a comment on our discussion board <b><i><Link href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss/discussions/6" target="_blank" rel="noopener noreferrer">LINK</Link></i></b>

                        <br />
                        or write to us at <Link href="mailto:webexpe13@gmail.com">webexpe13@gmail.com</Link>
                    </li>
                    <li className="mb-20">
