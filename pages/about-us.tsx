    ...
    return (
        <PageLayout PAGE_SEO={PAGE_SEO} home>
            <section className='container px-3 md:pb-20 md:pt-10 pt-20'>
                <div className="">
                    <Link href="https://webexpe.com/" target="_blank" rel="noopener noreferrer" className="block md:w-[15%] w-[50%] ">
                    ...
                    <Text p className='text-lg'>
                        ...
                        If you have a github account you can clone the project or use it as a template or else you can simply download the code from <Link href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss" className="underline font-bold">here</Link>.
                    </Text>
                    ...
                    <div className="flex flex-wrap justify-between">
                        <div className="md:w-auto w-full my-5">
                            ...
                            <List type={ListType.disc}>
                                ...
                                <li>Integrate with <Link href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer">Tailwind CSS </Link></li>
                        ...
                        <div className="md:w-auto w-full my-5">
                            ...
                            <List type={ListType.disc}>
                                ...
                                <li>Imp VS Code plugins: <br /> <Link href="https://marketplace.visualstudio.com/items?itemName=christian-kohler.path-intellisense" target="_blank" rel="noopener noreferrer">Path Intellisense</Link> , <br /> <Link href="https://marketplace.visualstudio.com/items?itemName=bradlc.vscode-tailwindcss" target="_blank" rel="noopener noreferrer">Tailwind CSS IntelliSense</Link> </li>
                            </List>
                        </div>
                    </div>
                    <Seperator />
                    ...
                    <Seperator />
                    <Text p className='text-lg'>
                        Created by <LinkTo href="https://www.linkedin.com/in/rupali-yadav-087bb4112/" external className="font-semibold">Rupali Yadav</LinkTo> and <LinkTo href="https://www.linkedin.com/in/mayur-nalwala/" external className="font-semibold">Mayur Nalwala</LinkTo> from <Link href="https://webexpe.com/" target="_blank" rel="noopener noreferrer" className="font-medium tracking-widest">WebExpe</Link> with ♥
                    </Text>
                    <Link href="https://www.buymeacoffee.com/webexpe13z" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
                        <Text p className="!text-lg leading-relaxed mb-0">
                            ...
                            You can also post any comments on our <Link href="https://github.com/webexpe13/blog-template-using-nextjs-typescript-tailwindcss/discussions" target="_blank" rel="noopener noreferrer"><u><i>github discussions</i></u></Link>.
                        </Text>
                    </div>
                </div>
            </section>
