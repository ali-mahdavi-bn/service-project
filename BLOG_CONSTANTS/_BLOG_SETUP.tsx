...
export const MAYUR: IAuthor = {
    ...
    profilePic: "",
    social: [{
        icon: <AiFillGithub/>, link: 'https://github.com/nmayur'
    }, {
        icon: <AiFillLinkedin/>, link: 'https://www.linkedin.com/in/mayur-nalwala/'
    },]
}
...
export const RUPALI: IAuthor = {
    ...
    profilePic: "",
    social: [{
        icon: <AiFillGithub/>, link: 'https://github.com/rupali-yadav'
    }, {
        icon: <AiFillLinkedin/>, link: 'https://www.linkedin.com/in/rupali-yadav-087bb4112/'
    },]
}
...
export const PRIMARY_NAV: iNavSetup = {
    type: NavbarType.DEFAULT, // max logo image height 40px
    ...
    // },
    logo: {
        type: LogoType.TEXT, logo: 'Next Blog',
    ...
    navLinks: [
        {
            ...
            label: 'خدمات', type: 'dropdown', path: '', children:[
                {
                    label: 'خدمات', path: '/services'
                },{
                    label: 'جز‌ئیات خدمات', path: '/service-details'
                },
            ]
        }
    ...
    sideNavLinks: [{
        ...
        label: 'Blog', type: 'dropdown', path: ''
    }, {
        label: 'About Us', path: '/about-us'
    }, {
        label: 'Support Us', path: 'https://www.buymeacoffee.com/webexpe13z', newTab: true
    }, {
        label: 'Github Repo',
        ...
        link: 'https://www.facebook.com/', icon: <AiFillFacebook/>
    }, {
        link: 'https://www.instagram.com/', icon: <AiFillInstagram/>
    }, {
        link: 'https://twitter.com/WebExpe', icon: <AiOutlineTwitter/>
    },]
}
